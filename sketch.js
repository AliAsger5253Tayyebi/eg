...
shield.setCollider("circle",0,0,70)
shield.debug=true;
...
function draw(){
 ...
 if(keyDown("s")&& shieldScore>0){
  ellipse(surviver.x,surviver.y,80,110)
  bulletGroup.bounceOff(shield);
...
//    surviver.velocityY=0; 
//  }
if(  keyDown("s")&& bulletGroup.isTouching(shield)){
...
shield.x=surviver.x
shield.y=surviver.y
if(bulletGroup.isTouching(surviver)){
score--;
}
